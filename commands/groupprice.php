...
$this->commands[$cmdName] = function($core, $args, $packet, $mType, $pmm, $alias, $user) {
	...
	$return = $core->function->Post("http://xat.com/web_gear/chat/TransferGroup.php","GroupName=".urlencode($args[1])."&agree=ON&Quote=Get+cost");
	...
	$core->function->sendMsg('Group '.$args[1].' worth '.$price[1].' xats.', $mType, $user->id);
};
